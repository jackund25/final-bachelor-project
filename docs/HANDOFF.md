...
> Rekaman lengkap ada di `docs/journey/` (tujuh part, lihat `README.md` di sana).
...
|---|---|---|
| standard | 0,335 ± 0,003 | 0,578 ± 0,083 |
| pc_rag | 0,383 ± 0,017 | 0,587 ± 0,081 |
| pc_rag_classifier | 0,424 ± 0,039 | 0,581 ± 0,078 |
| oracle | 0,794 ± 0,009 | — |

---

## 4. Keterbatasan K1–K12
...
**Lima paling menentukan batas klaim: K1, K3, K5, K10, K12.**
...
Alasannya mekanistik: `all-MiniLM-L6-v2` memakai *mean pooling*, dan rata-rata bersifat
komutatif.
