...
Kode program sistem cukup panjang dan telah disimpan secara lengkap pada repositori daring, sehingga tidak disertakan seluruhnya di dalam laporan ini. Kode sumber lengkap, meliputi pemrosesan data, model prediksi, \emph{engine digital twin}, pipeline RAG \emph{terkondisi-prediksi}, serta antarmuka, tersedia di:
\begin{center}
...
Potongan kode berikut merealisasikan inti kebaruan RAG \emph{terkondisi-prediksi}: kueri \emph{retrieval} dibangun dari nilai glukosa yang \emph{diprediksi}, bukan kondisi saat ini (bandingkan Algoritma~\ref{alg:pcrag}).
