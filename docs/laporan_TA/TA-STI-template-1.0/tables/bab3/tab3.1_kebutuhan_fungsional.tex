...
KF-01 & Sistem menerima masukan catatan \emph{logbook} terstruktur yang mencakup kadar glukosa, asupan karbohidrat, pemberian insulin, dan aktivitas fisik. & P2 & T1 \\[2pt]
...
dalam rentang sasaran sedangkan kondisi terprediksi tergolong hipoglikemia. & P1, P2 & T1, T2 \\[2pt]
...
sehingga keputusan klinis akhir tetap berada pada dokter. & P4 & T3 \\

\end{longtable}

\noindent\tabnotestyle Kolom asal mengacu pada persoalan yang diuraikan pada Subbab~\ref{subsec:bab3-identifikasi-persoalan}, yaitu P1 pengelolaan bersifat reaktif, P2 penafsiran manual dan tidak antisipatif, P3 prediksi terputus dari rekomendasi, dan P4 solusi berinfrastruktur berat tidak dapat diterapkan. Kolom tujuan mengacu pada tujuan penelitian pada Subbab~\ref{sec:bab3-
tujuan-penelitian}, yaitu T1 modul prediksi, T2 strategi \emph{query transformation} terkondisi-prediksi, dan T3 evaluasi menyeluruh beserta keamanan klinis.\normalsize
