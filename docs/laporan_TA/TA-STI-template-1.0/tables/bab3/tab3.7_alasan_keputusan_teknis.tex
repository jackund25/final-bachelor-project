...
\begin{longtable}{@{}p{2.6cm}p{2.6cm}>{\raggedright\arraybackslash}p{3.767cm}>{\raggedright\arraybackslash}p{3.767cm}@{}}
...
Model prediksi & Gradient Boosting & Dipilih berdasarkan ketepatan kelas kondisi dan keterterapan pada lingkungan komputasi penelitian. Keluaran dapat digunakan untuk jalur regresi dan klasifikasi dalam keluarga model yang sama. & Kepekaan terhadap hipoglikemia rendah bila kondisi diturunkan langsung dari hasil regresi, sehingga memerlukan pengklasifikasi kondisi terpisah. \\
