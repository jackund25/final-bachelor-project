...
\label{tab:tab6.20_sintesis_pemenuhan_tujuan}
    ...
    \hline
    T1 & Prediksi, Clarke Error Grid, finger-stick, conformal & Prediksi layak pada ruang uji; cakupan interval ketidakpastian mencapai target pada +30/+60 & Belum validasi klinis umum; hipoglikemia tetap menantang \\
    T2 & MRR natural/divergen, cross-fold, oracle & Kueri terkondisi-prediksi unggul kuat pada kasus divergen; tidak universal pada natural & Bergantung pada ketepatan kondisi prediksi dan konfigurasi retrieval \\
