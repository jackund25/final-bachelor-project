...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{1.100cm}>{\raggedright\arraybackslash}p{2.350cm}>{\raggedleft\arraybackslash}p{1.000cm}>{\raggedright\arraybackslash}p{7.075cm}>{\raggedleft\arraybackslash}p{1.350cm}@{}}
