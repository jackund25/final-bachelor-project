...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{1.400cm}>{\raggedright\arraybackslash}p{2.350cm}>{\raggedleft\arraybackslash}p{1.000cm}>{\raggedright\arraybackslash}p{6.525cm}>{\raggedleft\arraybackslash}p{1.600cm}@{}}
