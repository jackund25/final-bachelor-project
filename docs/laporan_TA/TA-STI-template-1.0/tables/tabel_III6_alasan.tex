...
%                     adalah MDI, dan MDI tidak boleh dilaporkan karena
...
% =====================================================================
\begin{longtable}{@{}p{2.9cm}p{3.1cm}p{4.6cm}p{4.2cm}@{}}
...
Model prediksi & \textsc{[tertahan]} & \textsc{[tertahan --- lihat catatan pada berkas sumber tabel ini]} & \textsc{[tertahan]} \\[2pt]
