...
\midrule
Penelusuran, kasus divergen & \textbf{Besar} & MRR 0,190 $\rightarrow$ 0,284 & Kondisi terkini menyesatkan; \\
(13,3\% jendela) & \emph{dan robust} & unggul 6/6 \emph{fold} ($p=0{,}031$) & hanya prediksi yang menolong \\
\addlinespace
Penelusuran, distribusi natural & \textbf{Tidak ada} & MRR 0,700 $\rightarrow$ 0,714 & 86,7\% jendela tidak divergen: \\
& & ($p=0{,}312$; t.s.) & RAG standar sudah tepat sasaran \\
\addlinespace
Penelusuran, pengklasifikasi & \textbf{Besar} & MRR 0,312 lawan 0,284 & Pengklasifikasi tidak menyusut \\
(divergen, vs regresi) & \emph{dan robust} & unggul 6/6 \emph{fold} ($p=0{,}031$) & ke tengah sebaran \\
\addlinespace
Penelusuran, pengklasifikasi & \textbf{Merugikan} & MRR 0,663 lawan 0,714 & Kondisi terkini sudah benar; \\
(natural, vs regresi) & & unggul 2/6 \emph{fold} (t.s.) & berpindah kelas justru menjauh \\
\addlinespace
