...
\input{tables/tabel_II1_perbandinganmodel.tex}
...
\input{tables/tabel_II3_potongan.tex}
...
Gambar~\ref{fig:rag-konvensional} memperlihatkan bahwa data \emph{logbook} langsung diterjemahkan menjadi kondisi glukosa saat ini, dan kondisi itulah yang menyusun kueri penelusuran. Panduan yang diperoleh karena itu menanggapi keadaan yang telah teramati. Alur yang diusulkan penelitian ini ditunjukkan pada Gambar~\ref{fig:rag-terkondisi}.
...
\input{tables/tabel_II4_metrik.tex}
...
\input{tables/tabel_II2_terkait.tex}
